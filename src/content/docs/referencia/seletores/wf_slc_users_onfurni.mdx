---
title: "SELETOR Wired: Habbos no Mobi"
description: Seleciona os usuários que estiverem sobre os mobis configurados.
sidebar:
  label: Habbos no Mobi
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Habbos no Mobi
  # image: # url preenchida automaticamente

  # == Dados do Mobi ==
  revision: 69982
  classname: wf_slc_users_onfurni
  name: "SELETOR Wired: Habbos no Mobi"
  description: Seleciona os usuários que estiverem sobre os mobis configurados.
