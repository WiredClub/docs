---
title: "SELETOR Wired: Escolha de Mobis"
description: Seleciona os mobis escolhidos manualmente na configuração.
sidebar:
  label: Escolha de Mobis
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Escolha de Mobis
  # image: # url preenchida automaticamente

  # == Dados do Mobi ==
  revision: 69982
  classname: wf_slc_furni_picks
  name: "SELETOR Wired: Escolha de Mobis"
  description: Seleciona os mobis escolhidos manualmente na configuração.
