---
title: "SELETOR Wired: Mobi com Altitude"
description: Seleciona os mobis que estiverem na altitude configurada.
sidebar:
  label: Mobi com Altitude
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Mobi com Altitude
  # image: # url preenchida automaticamente

  # == Dados do Mobi ==
  revision: 69982
  classname: wf_slc_furni_altitude
  name: "SELETOR Wired: Mobi com Altitude"
  description: Seleciona os mobis que estiverem na altitude configurada.
