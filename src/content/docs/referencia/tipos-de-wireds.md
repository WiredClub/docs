...
Veja a lista completa [aqui](/docs/referencia/ativadores/visao-geral/).
...
Veja a lista completa [aqui](/docs/referencia/efeitos/visao-geral/).
...
<!-- TODO: atualizar para direcionar para a seção correta -->
Veja a lista completa [aqui](/docs/referencia/efeitos/visao-geral/).
...
Veja a lista completa [aqui](/docs/referencia/condicoes/visao-geral/).
...
Veja a lista completa [aqui](/docs/referencia/seletores/visao-geral/).
...
Veja a lista completa [aqui](/docs/referencia/extras/visao-geral/).
...
Veja a lista completa [aqui](/docs/referencia/variaveis/visao-geral/).
...
Veja eles [aqui](/docs/referencia/contratos/visao-geral/).
