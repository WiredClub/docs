---
title: Classificação Maior Tempo - Mensal
description: Registra os maiores tempos do mês, mantendo no topo quem sustentar o objetivo por mais tempo.
sidebar:
  label: Classificação Maior Tempo - Mensal
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  # == Dados do Mobi ==
  revision: 68223
  classname: highscore_longesttime*4
  name: Classificação Maior Tempo - Mensal
  description: Registra os maiores tempos do mês, mantendo no topo quem sustentar o objetivo por mais tempo.
