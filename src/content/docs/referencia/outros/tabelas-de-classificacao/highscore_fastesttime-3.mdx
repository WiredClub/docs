---
title: Classificação Tempo mais Rápido - Semanal
description: Registra os melhores tempos da semana, mantendo no topo quem completar o objetivo mais rápido.
sidebar:
  label: Classificação Tempo mais Rápido - Semanal
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  # == Dados do Mobi ==
  revision: 68223
  classname: highscore_fastesttime*3
  name: Classificação Tempo mais Rápido - Semanal
  description: Registra os melhores tempos da semana, mantendo no topo quem completar o objetivo mais rápido.
