---
title: Classificação Maior Tempo - Diário
description: Registra os maiores tempos do dia, mantendo no topo quem sustentar o objetivo por mais tempo.
sidebar:
  label: Classificação Maior Tempo - Diário
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  # == Dados do Mobi ==
  revision: 68223
  classname: highscore_longesttime*2
  name: Classificação Maior Tempo - Diário
  description: Registra os maiores tempos do dia, mantendo no topo quem sustentar o objetivo por mais tempo.
