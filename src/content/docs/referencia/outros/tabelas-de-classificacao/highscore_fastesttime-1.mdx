---
title: Classificação Tempo mais Rápido - Geral
description: Registra os melhores tempos, mantendo no topo quem completar o objetivo mais rápido no histórico geral.
sidebar:
  label: Classificação Tempo mais Rápido - Geral
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  # == Dados do Mobi ==
  revision: 68223
  classname: highscore_fastesttime*1
  name: Classificação Tempo mais Rápido - Geral
  description: Registra os melhores tempos, mantendo no topo quem completar o objetivo mais rápido no histórico geral.
