---
title: Classificação Maior Tempo - Geral
description: Registra os maiores tempos, mantendo no topo quem sustentar o objetivo por mais tempo no histórico geral.
sidebar:
  label: Classificação Maior Tempo - Geral
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  # == Dados do Mobi ==
  revision: 68223
  classname: highscore_longesttime*1
  name: Classificação Maior Tempo - Geral
  description: Registra os maiores tempos, mantendo no topo quem sustentar o objetivo por mais tempo no histórico geral.
